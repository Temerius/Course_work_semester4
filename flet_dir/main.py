...
def main(page: ft.Page):
        ...
        def call_setting_panel(e):
            ...
            def change_figure_style(new_style: str):
                ...
                if success:
                    ...
                    page.controls[0].content.controls[0] = create_chess_board((USER.figure_style, USER.board_style), page, CHESS_BOARD)
                    page.update()
    ...
    server_address_input = ft.TextField(label="Server Address", value='192.168.100.10', width=300)
